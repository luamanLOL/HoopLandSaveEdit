...
2.  **Search for a Player**:
    *   Once the file is loaded, you will be taken to the player search screen.
    *   Select the league (Pro or College) and enter the first name of the player you want to edit.
    *   Click the "Search" button.

3.  **Edit Player Data**:
    *   If multiple players are found, select the correct one from the list.
    *   You will be taken to the modification screen where you can edit the player's information, attributes, skills, contract, and tendencies.
    *   You can also edit the game economy (coins and fans).

4.  **Save Changes**:
    *   After making your desired changes, click the "Save Modded File" button to download the modified save file.
